...
class CustomerActivity : AppCompatActivity() {
    ...
    private fun fetchCustomers(variable1: String, variable2: String, variable3: String) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val request = Request.Builder()
                    ...
                    .url("https://www1.paraiso-peru.com/rp/api/ws-conscomed-mv/?qry=GRAFICA&dni=$variable1&fdesde=$variable2&fhasta=$variable3")
                    .get()
